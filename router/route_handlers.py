...
from route_state import state, lock, reload_bloom, save_bloom, snap_to_pad, get_transitions, get_orphan_vias, get_clearance, get_density, get_nearest_track, handle_move, handle_place, handle_rotate, handle_place_via, handle_highlight, handle_mark, handle_clear_marks
...
class AgentHandler(http.server.BaseHTTPRequestHandler):
    ...
    def _handle_unroute(self, cmd):
        ...
        self._json_response({"ok": True, "removed": removed, "net": net})
